...
{
    private readonly UserManager<ZeniUser> _userManager;
    private readonly SignInManager<ZeniUser> _signInManager;
    ...
    public Callback(
        ...
        UserManager<ZeniUser> userManager,
        SignInManager<ZeniUser> signInManager)
    {
    ...
    private async Task<ZeniUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claims)
    {
        var sub = Guid.NewGuid().ToString();
            
        var user = new ZeniUser
        {
            Id = sub,
